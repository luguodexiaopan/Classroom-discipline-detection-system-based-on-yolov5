...
class MainWindow(QTabWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.model = self.model_load(weights="runs/train/exp_yolov5s/weights/exp6_best.pt",
    ...
    ***界面初始化***
    ...
    def initUI(self):
        ...
        self.left_img.setPixmap(QPixmap("images/new_UI/picture_2.png"))
        self.right_img.setPixmap(QPixmap("images/new_UI/shoe.png"))
        ...
        self.setTabIcon(0, QIcon('images/new_UI/picture_2.png'))
