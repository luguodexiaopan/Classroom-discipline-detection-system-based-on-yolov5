...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        # 初始化界面
        super().__init__()
        self.setWindowTitle('Classroom discipline detection system')
        ...
        self.model = self.model_load(weights="runs/train/exp_yolov5s/weights/exp25_5m6_best.pt",
    ...
    ***界面初始化***
    ...
    def initUI(self):
        ...
        self.left_img.setPixmap(QPixmap("images/UI/picture_up.jpg"))
        ...
        up_img_button.setStyleSheet("QPushButton{color:white}"
                                    "QPushButton:hover{background-color: rgb(46,139,87);}"
                                    "QPushButton{background-color:rgb(60,179,113)}"
        ...
        self.vid_img = QLabel()
        self.vid_img.setPixmap(QPixmap("images/UI/video_up2.jpg"))
        ...
        self.vid_stop_btn.setStyleSheet("QPushButton{color:white}"
                                        "QPushButton:hover{background-color: rgb(139,0,0);}"
                                        "QPushButton{background-color:rgb(225,0,0)}"
                                        "QPushButton{border:2px}"
                                        "QPushButton{border-radius:5px}"
                                        "QPushButton{padding:5px 5px}"
                                        "QPushButton{margin:5px 5px}")
        ...
        label_super.setText("<a href='https://github.com/luguodexiaopan'>你也可以在这里找到我-->路过的小盼</a>")
        ...
        self.setTabIcon(1, QIcon('images/UI/you.jpg'))
        self.setTabIcon(2, QIcon('images/UI/you.jpg'))
