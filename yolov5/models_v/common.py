...
from utils_v.datasets import exif_transpose, letterbox
from utils_v.general import (LOGGER, check_requirements, check_suffix, colorstr, increment_path, make_divisible,
                           non_max_suppression, scale_coords, xywh2xyxy, xyxy2xywh)
from utils_v.plots import Annotator, colors, save_one_box
from utils_v.torch_utils import time_sync
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights='yolov5s.pt', device=None, dnn=True):
        ...
        if jit:  # TorchScript
            ...
            model = torch.jit.load(w) if 'torchscript' in w else attempt_load(weights, device)
